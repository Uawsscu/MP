...
def match():
    img = cv2.imread("/home/uawsscu/PycharmProjects/Pass1/object_recognition_detection/pic/herbal20.jpg")  # image
    temp = cv2.imread("/home/uawsscu/PycharmProjects/Pass1/object_recognition_detection/pic/herbal30.jpg")  # image template
    try:
        dist = int(sys.argv[3])
    except IndexError:
        dist = 200
